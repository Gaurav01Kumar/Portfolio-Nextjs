      ...
      >
        <div className=" md:w-80 w-full p-3 border border-neutral-800   rounded-2xl h-full bg-[#1C1C1C]  ">
          ...
          <div className="w-full mt-5 text-neutral-300">
            ...
            <p className="text-[17px]  font-RubikRegular my-3">
              'm an experienced Full Stack Developer with over 1.4 years months
              of experience,
              <br />I have honed my expertise in technologies such as React,
              React Native, Node.js, MongoDB, and Express. <br /> I am eager to
              take on new challenges and collaborate on innovative projects that
              leverage technology to solve real-world problems. My goal is to
              deliver high-quality, scalable solutions that drive success for my
              clients.
            </p>
            ...
            <div className="mt-6 flex justify-between text-sm">
              ...
              <div className="flex items-center gap-x-1">
                <PiMagicWandThin />
                <span className="text-xs font-RubikRegular">10 Projects</span>
              </div>
            </div>
            ...
            <div className="my-4 ">
              ...
              <div className="mt-7 flex  justify-between">
                <div className="flex gap-x-3">
                  ...
                  <div className="-mt-1">
                    <h3 className="text-sm font-RubikMedium text-emerald-600 ">
                      Full stack developer
                    </h3>
                    <p className="text-[9px] ">Nonstandard Digital</p>
                  </div>
                </div>
              ...
              <div className="my-3 flex  justify-between">
                <div className="flex gap-x-3">
                  ...
                  <div className="-mt-1">
                    ...
                    <p className="text-[9px]">Shoptop</p>
                  </div>
                </div>
                <small className="text-[9px] text-neutral-300">
